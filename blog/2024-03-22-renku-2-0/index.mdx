...
levereage the flexibility of Renku 2.0 in multiple situations, for example:
...
sources to their projects, like S3 buckets. Depending on the nature of the
storage, they may be used in read-only or in read-write mode. However, projects
...
Users can bring git repositories into their project from the connected
Renku-managed GitLab instance, from an external GitLab instance, or from GitHub.
The access to these repositories is governed by the 3rd party provider, not
by Renku. We encourage everyone to version their code, but if the project does
not require versioning (yet), you are not obligated to use it!
...
pleae drop us an email!

## Further information

Are you interested in learning more about Renku 2.0? If so, have a look at the following resources:

- Watch our [Renku 2.0 webinar](https://www.youtube.com/channel/UCMF2tBtWU1sKWvtPl_HpI4A)
- Check out the [roadmap](https://docs.google.com/presentation/d/1-W56dVgsR2yzrq2slA1EIyVso10jlkSazce4xOOKIZE/edit?usp=sharing)

If you want to test Renku 2.0 beta or participate in UX research [contact us!](hello@renku.io) - we look forward to hearing from you!
