...
a simple (and performant!) place to store your data in Renku - no external data connection required!
...
With **Apps**, you can now publish your project as a live app that's ready to open at a public URL,
with no session to launch first. You can serve dashboards built with Streamlit or Shiny, interactive demos
and model endpoints you can send requests to. All directly from your project.
...
Check [our demo project on energy demand for buildings](https://renkulab.io/p/renku-team/energy-consumption-monitoring).
...
Once Project Storage is activated for your project, claim your project storage via the new tab in the [data connector creation menu](https://docs.renkulab.io/en/latest/docs/users/data/project-storage).

Once created, project storage is available in every session and
...
![Project storage](project-storage-modal.png)
