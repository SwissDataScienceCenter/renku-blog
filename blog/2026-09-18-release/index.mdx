...
_For more details on Apps, have a look at the [documentation](https://docs.renkulab.io/en/latest/docs/users/compute/app/)._
...
from the _Add data connector_ screen. Once created, it's available in every session and
