...
authors: [rokroskar, laura, jimena]
tags:
  - Poster
  - Event
image: ./image_1.png
...
on Sept. 4th and 5th 2024 in Aarau (Switzerland) and brought together specialists related to
...
code repositories. These data and code come to life in Renku sessions,
where data scientists, statisticians and other practitioners can work in their prefererred
compute environment (Python, RStudio, Matlab, VSCode or others) with the compute infrastructure
that they select. Having data, code, and compute under the same umbrella makes it easier to
