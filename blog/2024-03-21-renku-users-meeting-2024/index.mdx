...
- 14:15-15:15 Renku in the Wild: User Presentations from Research & Teaching
  - **Reproducible Data Acquisition and Processing in X-ray Imaging Research** Michał Rawlik, Scientist at Paul Scherrer Institute (PSI)
  - **How Renku can help us to detect natural hazards: A case study from environmental seismology** Patrick Paitz, Postdoc at Swiss Federal Institute for Forest, Snow and Landscape Research (WSL)
  ...
  - **Renku in astronomy** Volodymyr Savchenko, Senior Data Scientist & Lecturer at École Polytechnique Fédérale de Lausanne (EPFL)
- 15:15-15:30 Break
