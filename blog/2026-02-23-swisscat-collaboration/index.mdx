...
## The Renku Platform as a Solution

Renku offers an ideal platform to overcome this challenge as it allows to connect:
...
## Data management Integration with Renku

Data generated at ETHZ SwissCAT+ are stored in a data repository (for example on Polybox) and code is
located in git repositories. A Renku project can be created that connects the data and the code and
...
SwissCAT+. With Renku, they only need to create a user account and be granted the access rights
