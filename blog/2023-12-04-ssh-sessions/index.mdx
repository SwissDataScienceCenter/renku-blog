...
This post discusses the convenience of working in RenkuLab through SSH access to your sessions and provides a guide for starting an SSH session. Thus, this post familiarises the readers with integrated development environments (IDEs). Do not doubt to contact us in [General](https://renku.discourse.group/c/general/1) in case you have any comment or suggestion!
