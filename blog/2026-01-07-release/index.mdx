...
tags:
  ...
  - Integrations
  - HPC
image: ./cover-image-post-january.png
...
at what’s new in **Renku releases 2.10.0 through 2.12.1.**
...
Working with data from [EnviDat](https://envidat.ch), the environmental data portal of the Swiss Federal Research
...
Renku automatically syncs the metadata, making the data searchable within Renku
(just like our Zenodo and Dataverse integrations). When you launch a new session
the data is automatically mounted, ready for immediate analysis without manual
downloads.

**Discover other datasets**: We have also made it easier to discover other datasets
from specific providers; for example, on the search page you can use a [query](https://renkulab.io/search?q=publisher_name%3AEnviDat) like `publisher_name:envidat` to see
...
**Acknowledgment:** We are very grateful for the support of the [ETH Domain Open Research Data program](https://ethrat.ch/en/eth-domain/open-research-data/), which made the development of these
integrations possible through project funding in Measure 2, and for our collaboration with the [NEXUS](https://www.nexus.ethz.ch/) team who implemented the OpenBIS feature.
...
[your launcher](https://docs.renkulab.io/en/latest/docs/users/sessions/guides/environments/create-environment-with-custom-packages-installed), simply select the appropriate architecture, and Renku will
...
Big thanks to our collaborators at [Idiap](https://www.idiap.ch) for helping us build this functionality!

![arm](arm-selector.png)
...
This creates a clearer boundary for large teams, ensuring that only Project
Owners and Group Owners remain in control of critical project configurations.

Make sure to check the [group permissions page](https://docs.renkulab.io/en/latest/docs/users/collaboration/permissions#group-permissions) in our documentation for further insights.
...
break, we have a solution. Simply [**fill out this
