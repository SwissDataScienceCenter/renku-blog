...
### Seamless EnviDat Integration

Working with EnviDat—the environmental data portal of the Swiss Federal Research
Institute WSL—is now effortless.

**How it works**: Simply copy a dataset’s DOI and create a Renku data connector.

**The Benefit**: Renku automatically syncs the metadata, making the data searchable within Renku (just like our Zenodo and Dataverse integrations). Once connected, the data is automatically mounted in your session, ready for immediate analysis without manual downloads.

### Enhanced OpenBIS Support

For researchers using OpenBIS, we’ve introduced a dedicated data connector type
to streamline navigation and data fetching.
