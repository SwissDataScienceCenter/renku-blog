...
Want to learn more? Check out our [Deep Dive: What’s New in Renku
2.0](ENTER DEEP DIVE URL HERE).
...
One of the key enhancements on the horizon is the ability to **customize your compute
environment**. In addition, we’ll be making it easier to **migrate projects** into Renku 2.0.
...
love to hear from you—reach out with your feedback, questions, or ideas! Your insights are
invaluable as we refine the platform. We can’t wait to see what you’ll build with Renku 2.0!