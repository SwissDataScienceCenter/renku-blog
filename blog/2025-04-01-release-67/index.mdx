...
slug: release-67
title: |
  RenkuLab 0.67.0: Project Documentation, Private Data Connectors & Project Migration
authors: [laura]
tags:
  - Release
  - Renku 2.0
...
We're so excited about this feature we gave it a whole blog post of its own. Read more [here](../2025-03-28-built-envs/index.html)!
...
You can now easily migrate 1.0 projects to Renku 2.0. At the top of Renku 1.0 projects, you'll now
...
With this update, you can create data connectors for a project, for a group, or for personal use.
And when you link a personal data connector to a project, that data connector stays private. Other
...
Remember: Being able to see a Renku data connector is not the same as being able to access the data
itself! Access to data connected with Renku is always managed externally by the system where the
data lives. If the data requires credentials, Renku will never give another user access without
...
And if you're curious about what new features are in the ahead, check out our
