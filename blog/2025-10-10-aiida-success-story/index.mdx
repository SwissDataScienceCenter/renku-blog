...
From technical local installations to one-click data exploration: How the Materials Cloud Archive
simplified researcher access to computational materials science data using RenkuLab.

![Blog post_ AiiDA_Renku Success Story.png](Blog post_ AiiDA_Renku Success Story.png)

<!-- truncate -->

## The Challenge: Valuable Data Behind Technical Barriers

The [Materials Cloud Archive](https://www.materialscloud.org/home) (MCA) faced a common research
problem: they hosted valuable computational materials science data, but accessing it required
complex technical setup.

"Exploring AiiDA archives historically required users to install AiiDA locally with complex
dependencies like PostgreSQL and RabbitMQ," explains the development team. "Users also needed prior
knowledge of AiiDA's API to explore the data."

This complexity meant valuable research data was effectively locked away from researchers who
weren't already familiar with AiiDA. Even experienced users had to manually download archives,
configure environments, and set up profiles before beginning actual research—wasting time that could
be spent on discovery.

## The Solution: One-Click Access with Renku Launch Links

The AiiDA team discovered Renku's collaborative data science platform and built an elegant
integration using Renku's Launch Links. They created a template Renku project with AiiDA
pre-installed, and then connected the two platforms via parameterized [launch
links](https://blog.renkulab.io/release-2025-05/#share-session-launch-links) that pass specific
archive IDs directly into Renku sessions.
