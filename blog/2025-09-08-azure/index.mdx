...
![migration_image](migration_image.png)
...
flexibility our users require while also giving us the tools we need to optimize costs. At the time
we needed to make a decision about where to migrate our production instance, the new Switch Cloud
offering was not quite in a production stage yet, so our choices were limited to the major public cloud offerings.
After testing all of them, the decision was made to choose Microsoft Azure as the new home for [renkulab.io](https://renkulab.io).
...
as possible. This new integration will take advantage of the new Switch Cloud infrastructure, which should
